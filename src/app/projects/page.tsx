...
export default function ProjectsPage() {
  return (
    <>
      ...
      <section className="section reveal" aria-labelledby="travo-engagements-title" id="travo-engagements">
        <div className="wrap">
      ...
      <section className="section section-soft reveal" aria-labelledby="principal-projects-title" id="prior-experience">
        <div className="wrap">
